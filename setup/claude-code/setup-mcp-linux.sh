...
echo "Setting up Yaade for Claude Code (Linux)"
echo "========================================="
...
echo ""
echo "To also install the Claude Code slash commands (/remember, /recall, etc.):"
echo "   ./setup/claude-code/install-skills.sh"
echo ""
